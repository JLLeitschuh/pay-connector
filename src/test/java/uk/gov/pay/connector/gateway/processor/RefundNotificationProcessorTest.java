...
public class RefundNotificationProcessorTest {
    ...
    public void shouldInvokeSendEmailNotificationsForSuccessfulRefunds() {
        ...
        verify(userNotificationService).sendRefundIssuedEmail(refundEntity, chargeEntity, gatewayAccountEntity);
    }
    ...
    public void shouldNotInvokeSendEmailNotifications_WhenRefundStatusIsNotRefunded() {
        ...
        verify(userNotificationService, never()).sendRefundIssuedEmail(refundEntity, chargeEntity, gatewayAccountEntity);
    }
